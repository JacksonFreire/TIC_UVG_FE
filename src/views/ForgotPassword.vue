<template>
    <div class="min-h-screen flex items-center justify-center bg-white">
      <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form @submit.prevent="submit">
          ...
          <button 
            type="submit" 
            class="w-full px-4 py-2 font-medium text-white bg-indigo-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm hover:bg-indigo-700"
          >
            Enviar
          </button>
  ...
  <style scoped>
  /* Mejora la transición para los mensajes de error */
